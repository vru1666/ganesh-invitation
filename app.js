...
(function () {
  ...
  /* --- Configuration -------------------------------------- */
  var CONFIG = {
    mapsUrl: 'https://maps.app.goo.gl/G6KsRvRrJZXQDVyz5',
    showWhatsApp: true,
    showPetals: true,
    shareMessage: '॥ गणपती बाप्पा मोरया ॥ 🙏\n\n' +
              'आपण सहकुटुंब सहपरिवार आमच्या घरी गणपती बाप्पांच्या दर्शनासाठी व आरतीसाठी अवश्य यावे.\n\n' +
              'दिनांक: १४ सप्टेंबर २०२६\n\n' +
              '📍 मार्गदर्शनासाठी खालील लिंकवर क्लिक करा: '
  };
